...
var ClientAnimationId = mapset.NewThreadUnsafeSet(
	...
	"animation.armadillo.baby_peek",
	"animation.armadillo.baby_roll_up",
	"animation.armadillo.baby_rolled_up",
	"animation.armadillo.baby_unroll",
	"animation.armadillo.baby_unroll_fast",
	"animation.armadillo.baby_walk",
	...
	"animation.axolotl.baby_idle_floor",
	"animation.axolotl.baby_idle_floor_underwater",
	"animation.axolotl.baby_idle_underwater",
	"animation.axolotl.baby_swim",
	"animation.axolotl.baby_walk_floor",
	"animation.axolotl.baby_walk_floor_underwater",
	...
	"animation.camel.baby_dash",
	"animation.camel.baby_idle",
	"animation.camel.baby_sit",
	"animation.camel.baby_sit_down",
	"animation.camel.baby_stand_up",
	"animation.camel.baby_walk",
	...
	"animation.fox.baby_pounce",
	"animation.fox.baby_sit",
	"animation.fox.baby_sleep",
	"animation.fox.baby_walk",
	"animation.fox.baby_wiggle",
	...
	"animation.panda.baby_rolling",
	"animation.panda.baby_sitting",
	...
	"animation.rabbit.idle_head_tilt",
	"animation.rabbit.move",
	"animation.rabbit.move.baby",
	"animation.rabbit.move.v2",
	...
	"controller.animation.axolotl.move.v2",
	...
	"controller.animation.camel_husk.general",
	"controller.animation.camel_husk.idle",
	...
	"controller.animation.polar_bear.move",
	"controller.animation.rabbit.baby",
	"controller.animation.rabbit.general",
	"controller.animation.rabbit.general.v2",
	...
	"controller.animation.sulfur_cube.offset",
	"controller.animation.sulfur_cube.swelling",
